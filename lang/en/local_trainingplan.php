<?php
/**
 * Strings for component 'local_trainingplan', language 'en'
 * @package   local_trainingplan
 * @author      Robert Tyrone Cullen
 */
//A
    $string['annual_lw'] = 'Annual Leave Weeks';
    $string['auditory'] = 'Auditory';
    $string['appren_hpw'] = 'Apprentice Hours Per Week';
    $string['asp_and_cg'] = 'Aspirations & Career Goals';
    $string['area_of_stren'] = 'Area of Strength';
    $string['act_otjh_comp'] = 'Actual OTJH Completed (as per log)';
    $string['act_ed'] = 'Actual End Date';
    $string['act_ead'] = 'Actual End/Achievment Date';
    $string['act_review'] = 'Actual Review';
    $string['add_new_rec'] = 'Add New Record';
    $string['additional_sa'] = 'Additional Support Arrangements';
//B
    $string['btm'] = 'Back to menu';
    $string['bksb_rm'] = 'BKSB Result Maths';
    $string['bksb_re'] = 'BKSB Result English';
//C
    $string['clear'] = 'Clear';
    $string['choose_a_plan'] = 'Choose A Training Plan';
    $string['choose_a_option'] = 'Choose A Option';
    $string['coach_sign'] = 'Coach signature';
    $string['coach'] = 'Coach';
    $string['contract_hpw'] = 'Contracted Hours Per Week';
    $string['choose_epao'] = 'Choose EPAO';
    $string['c_and_g'] = 'C & G';
    $string['choose_fund_source'] = 'Choose Funding Source';
...
//E
    $string['employ_or_store'] = 'Employer or Store';
    $string['employer'] = 'Employer';
    $string['epao'] = 'EPAO';
    $string['employer'] = 'Employer';
//F
    $string['fund_source'] = 'Funding Source';
    $string['fr_awards'] = 'FR Awards';
...
//L
    $string['length_of_prog'] = 'Length of Programme';
    $string['levy'] = 'Levy';
    $string['learn_style'] = 'Learning Style';
    $string['less_al'] = 'Less Annual Leave';
    $string['long_tg'] = 'Long Term Goals';
    $string['level'] = 'Level';
...
//O
    ...
    $string['otjh'] = 'OTJH';
    $string['otj_calc'] = 'Off The Job Calculation';
    $string['otj_tasks'] = 'OTJ Tasks';
//P
    $string['pluginname'] = 'Training Plan';
    $string['plan_end_date'] = 'Planned End Date';
    $string['plan_sd'] = 'Planned Start Date';
...
//T
    ...
    $string['total_months'] = 'Total Months';
...
//W
    $string['weeks_on_prog'] = 'Weeks on Programme';
//X
//Y
//Z